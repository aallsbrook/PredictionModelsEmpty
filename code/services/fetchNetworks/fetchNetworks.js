 ...
 */
 ...
 /**
 * @typedef {object} fetchNetworksParams
 ...
 */
 ...
 /**
 * Fetches a list of items from the "Networks" collection
 * @param {{ params: fetchNetworksParams | Networks }} req
 * @param {fetchNetworksParams | Networks} req.params
 * @param {CbServer.Resp} resp
 */
function fetchNetworks(req, resp) {
  log(req)  
  ...
  if (cbQuery) {
    ...
    ["name", "nodes"].forEach(function(name) {
