...
/**
 * @typedef {object} deleteFeatureGroupsParams
 * @property {string} item_id
...
/**
 * Deletes items from the "FeatureGroups" collection
 * @param {{ params: deleteFeatureGroupsParams }} req
 * @param {deleteFeatureGroupsParams} req.params
 * @param {CbServer.Resp} resp
 */
function deleteFeatureGroups(req, resp) {
  log(req)    
