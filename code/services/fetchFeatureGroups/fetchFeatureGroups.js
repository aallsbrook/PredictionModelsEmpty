 ...
 */
 ...
 /**
 * @typedef {object} fetchFeatureGroupsParams
 ...
 */
 ...
 /**
 * Fetches a list of items from the "FeatureGroups" collection
 * @param {{ params: fetchFeatureGroupsParams | FeatureGroups }} req
 * @param {fetchFeatureGroupsParams | FeatureGroups} req.params
 * @param {CbServer.Resp} resp
 */
function fetchFeatureGroups(req, resp) {
  log(req)  
