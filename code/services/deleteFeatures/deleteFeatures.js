...
/**
 * @typedef {object} deleteFeaturesParams
 * @property {string} item_id
...
/**
 * Deletes items from the "Features" collection
 * @param {{ params: deleteFeaturesParams }} req
 * @param {deleteFeaturesParams} req.params
 * @param {CbServer.Resp} resp
 */
function deleteFeatures(req, resp) {
  log(req)    
